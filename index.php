...
<div class="top-hearo-container">
    <div class="hero-text-container">
        <div class="hero-text">
            ...
            <p>.فرصتك لتعلم مهارة مستقبلية جديدة طور ذاتك واصنع مستقبلك
            </p>
            <form action="">
                <input type="email" name="" id="">
                <input type="submit" value="تعلّم الان !">
            </form>
            <p style="margin: 0; font-family: 'Cairo'; font-style: normal; font-weight: 700; font-size: 30px; color: var(--yellow-);">نقدم دورات من طرف اخصائيين في المجال </p>
            <p style="margin: 0; font-family: 'Cairo'; font-style: normal; font-weight: 400; font-size: 21px; color: var(--white-);"> فرصتك لتعلم مهارة مستقبلية جديدة طور ذاتك واصنع مستقبلك.  </p>
...
<div class="courses-container">
    <div class="courses-content">
        ...
        <div class="courses-filter">
            <button data-filter="all" class="courses-filter-item active-filter" data-aos="fade-up">الكل</button>
            <button data-filter="graphic-design" class="courses-filter-item" data-aos="fade-up">الفن والتصميم</button>
            <button data-filter="photo-video-montage" class="courses-filter-item" data-aos="fade-up">التصوير والمونطاج</button>
            <button data-filter="marketing-digitale" class="courses-filter-item" data-aos="fade-up">التسويق الالكتروني</button>
        </div>
                ...
                <div class="student-reviews-item">
                    ...
                    <div class="student-reviews-name-desc-star-group">
                        ...
                        <p class="student-review-desc">
                            شكرا على الدورات لي كتقدمو أنا شخصيا استافدت من دورة الفوتوشوب
                        </p>
                    </div>
                </div>
                <div class="student-reviews-item">
...
<div class="contact-banner-container">
    <div class="contact-item">
        ...
        <div>
            ...
            <p class="contact-banne-tool" data-aos="fade-right">تواصل عبر الواتس اب</p>
        </div>
    </div>
    <div class="contact-item">
        <div>
        ...
        <div>
            ...
            <p class="contact-banne-tool" data-aos="fade-right">تواصل عبر البريد الالكتروني</p>
        </div>
    </div>
    <div class="contact-item">
        <div>
        ...
        <div>
            ...
            <p class="contact-banne-tool" data-aos="fade-right">تواصل عبر الهاتف</p>
        </div>
    </div>
</div>
